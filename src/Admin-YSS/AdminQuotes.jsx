...
import { uploadQuoteImageToCloudinary, addQuoteToFirestore, updateQuoteInFirestore, deleteQuoteFromFirestore, getQuotesFromFirestore } from '../Database/Firebase'; // Import Firestore functions
          ...
          quotes.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {quotes.map((quote, index) => (
                <div key={index} className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition duration-300">
